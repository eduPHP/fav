...
export default function Home() {
  ...
  return (
    <>
      ...
      <button onClick={handleScrollToTop} type="button" className="fixed text-white right-20 bottom-8 bg-gray-500 rounded p-3 cursor-pointer transition opacity-40 hover:opacity-60">
